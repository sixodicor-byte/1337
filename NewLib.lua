...
function Compkiller:_KeybindHandler(Parent: Frame , ObjectType: string , ElementAPI: Toggle & Slider , Signal , Zindex: number , ElementCFG: Slider)
	...
	UserInputService.InputBegan:Connect(function(Input,Typing)
		if Input.KeyCode.Name == APIRef.Keybind or Input.KeyCode == APIRef.Keybind or (Input.UserInputType == Enum.UserInputType.MouseButton1 and APIRef.Keybind == "MouseLeft") or (Input.UserInputType == Enum.UserInputType.MouseButton2 and APIRef.Keybind == "MouseRight") or (Input.UserInputType == Enum.UserInputType.MouseButton3 and APIRef.Keybind == "MouseMiddle") then
			...
			while not Selected do
				...
				if Key.KeyCode ~= Enum.KeyCode.Unknown and not IsBlacklist(Key.KeyCode) and not IsBlacklist(Key.KeyCode.Name) then
					...
					elseif Key.UserInputType == Enum.UserInputType.MouseButton2 and not IsBlacklist(Enum.UserInputType.MouseButton2) and not IsBlacklist("MouseRight") then
						Selected = "MouseRight";
					elseif Key.UserInputType == Enum.UserInputType.MouseButton3 and not IsBlacklist(Enum.UserInputType.MouseButton3) and not IsBlacklist("MouseMiddle") then
