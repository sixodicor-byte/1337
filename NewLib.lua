...
if typeof(clonefunction) == "function" then
	...
	if isfolderSuccess == false or typeof(isfolderError) ~= "boolean" then
		isfolder = function(folder)
			local success, data = pcall(isfolderCopy, folder)
			return if success then data else false
		end

		isfile = function(file)
			local success, data = pcall(isfileCopy, file)
			return if success then data else false
		end

		listfiles = function(folder)
			local success, data = pcall(listfilesCopy, folder)
...
getgenv().LinoriaSaveManager = SaveManager
