...
--// Always use Loadstring: local ImGui = loadstring(game:HttpGet('https://github.com/depthso/Roblox-ImGUI/raw/main/ImGui.lua'))()
local ImGui = {
	Animations = {
		Buttons = {
			MouseEnter = {
...
function ImGui:ContainerClass(Frame: Frame, Class, Window)
	...
	function ContainerClass:ColorPicker(Config)
		...
		local Header = self:CollapsingHeader({
			Title = Config.Label or "Color Picker",
			Open = false
		})
